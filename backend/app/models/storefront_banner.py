from sqlalchemy import Column, String, ForeignKey, Boolean, Integer, DateTime, Enum, Index, JSON
...
class StorefrontBanner(Base):
    ...
    banner_type = Column(Enum(BannerType), nullable=False, default=BannerType.CUSTOM)
    placement = Column(Enum(BannerPlacement), nullable=False)
    ...
    asset_id = Column(UUID(as_uuid=True), ForeignKey("storefront_assets.id"), nullable=True)
