...
from sqlalchemy import Boolean, Column, DateTime, ForeignKey, String, JSON, Text
...
class FeatureFlag(Base):
    ...
    # Tenant overrides
    tenant_overrides = relationship("TenantFeatureFlagOverride", back_populates="feature_flag")
...
class TenantFeatureFlagOverride(Base):
    ...
    feature_flag = relationship("FeatureFlag", back_populates="tenant_overrides")
    ...
    __table_args__ = (
        ...
        {"uniqueConstraints": {"tenant_feature_flag_uc": ("tenant_id", "feature_flag_id")}}
    )
