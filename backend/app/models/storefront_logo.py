from sqlalchemy import Column, String, ForeignKey, Boolean, Enum, DateTime, Index
...
class StorefrontLogo(Base):
    ...
    # Asset reference
    asset_id = Column(UUID(as_uuid=True), ForeignKey("storefront_assets.id"), nullable=False)
    
    # Display settings
    display_settings = Column(JSONB, nullable=False, default=lambda: {
        "maxWidth": "200px",
        "maxHeight": "80px",
        "padding": "0",
    ...
    # Responsive behavior
    responsive_settings = Column(JSONB, nullable=False, default=lambda: {
    ...
    __table_args__ = (
        ...
        Index("idx_unique_active_logo_variant", "tenant_id", "variant", "is_active", unique=True, postgresql_where=is_active),
        # General indexes
