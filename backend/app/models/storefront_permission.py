from sqlalchemy import Column, String, ForeignKey, UniqueConstraint, Index, Enum, DateTime, JSON
...
class StorefrontPermission(Base):
    ...
    role = Column(Enum(StorefrontRole), nullable=False, default=StorefrontRole.VIEWER)
