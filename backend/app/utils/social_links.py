...
def generate_whatsapp_link(
    phone_number: str, product_name: str, caption: str = None
) -> str:
    """
...
def generate_instagram_share(
    instagram_handle: str, caption: str = None, image_url: str = None
) -> Dict[str, str]:
    """
    ...
    """
    dm_link = (
        f"https://instagram.com/direct/t/{instagram_handle}"
        if instagram_handle
        else None
    )
    profile_link = (
        f"https://instagram.com/{instagram_handle.lstrip('@')}"
        if instagram_handle
        else None
    )
...
def generate_facebook_share_link(
    url: str, quote: str = None, hashtag: str = None
) -> str:
    """
...
def generate_tiktok_share(tiktok_handle: str, caption: str = None) -> Dict[str, str]:
    ...
    """
    profile_link = (
        f"https://www.tiktok.com/@{tiktok_handle.lstrip('@')}"
        if tiktok_handle
        else None
    )
...
def generate_twitter_share_link(
    url: str, text: str = None, hashtags: list = None, via: str = None
) -> str:
    """
