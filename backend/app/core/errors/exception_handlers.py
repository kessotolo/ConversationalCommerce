...
async def product_permission_handler(request: Request, exc: ProductPermissionError) -> JSONResponse:
...
async def concurrent_modification_handler(request: Request, exc: ConcurrentModificationError) -> JSONResponse:
