...
def authentication_error(detail: str = "Authentication failed", error_code: str = "AUTHENTICATION_FAILED") -> JSONResponse:
    return create_error_response(status.HTTP_401_UNAUTHORIZED, detail, error_code)
...
def authorization_error(detail: str = "Authorization failed", error_code: str = "AUTHORIZATION_FAILED") -> JSONResponse:
    return create_error_response(status.HTTP_403_FORBIDDEN, detail, error_code)
...
def validation_error(detail: str = "Validation error", fields: Dict[str, str] = None, error_code: str = "VALIDATION_ERROR") -> JSONResponse:
    ...
    return create_error_response(status.HTTP_422_UNPROCESSABLE_ENTITY, detail, error_code, additional_info)


def business_logic_error(detail: str = "Business logic error", error_code: str = "BUSINESS_LOGIC_ERROR") -> JSONResponse:
...
def rate_limit_error(detail: str = "Rate limit exceeded", error_code: str = "RATE_LIMIT") -> JSONResponse:
