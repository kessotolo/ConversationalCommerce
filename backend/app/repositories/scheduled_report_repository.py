...
from backend.app.models.analytics import ScheduledReport as ScheduledReportModel
from backend.app.schemas.analytics import ScheduledReportCreate, ScheduledReportUpdate, ScheduledReport
