    ...
    for entry in data.get("entry", []):
        for change in entry.get("changes", []):
            ...
            for message in value.get("messages", []):
                ...
                to_number = message.get("to")  # The business number that received the message
                ...
                if not tenant:
                    ...
                    logger.warning(f"Received message to unknown WhatsApp number: {to_number}")
                ...
                response = result.payload.get("chat_response", "I received your message.")
                if response:
