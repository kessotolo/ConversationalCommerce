...
from backend.app.schemas.shipping import Address, ShippingDetails, ShippingMethod
from backend.app.services.shipping_service import ShippingService, shipping_service
