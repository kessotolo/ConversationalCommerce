...
async def get_activities(
    request: Request,
    time_range: str = Query("24h", description="Time range to filter activities (1h, 24h, 7d, 30d)"),
    filter_type: str = Query("all", description="Filter type (all, high, alerts, errors)"),
        ...
        for activity in activities:
            ...
            response_items.append(
                ActivityResponse(
                    ...
                    details=ActivityDetails(**activity.details) if activity.details else ActivityDetails(),
                    severity=severity,
