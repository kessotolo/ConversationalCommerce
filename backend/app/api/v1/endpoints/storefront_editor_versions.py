...
from app.schemas.storefront_version import StorefrontVersionResponse, StorefrontVersionList
...
@router.get("/{tenant_id}/versions/{version_id}", response_model=StorefrontVersionResponse)
...
@router.post("/{tenant_id}/versions/{version_id}/restore", response_model=Dict[str, Any])
