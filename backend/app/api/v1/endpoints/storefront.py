...
async def get_featured_products(
    ...
    tenant_id = uuid.UUID(tenant_context["tenant_id"])
    products = await storefront_content_service.get_featured_products(db, tenant_id, limit, skip)
...
async def get_product_detail(
    ...
    tenant_id = uuid.UUID(tenant_context["tenant_id"])
    product_detail = await storefront_content_service.get_product_detail(db, tenant_id, product_id)
