...
async def get_storefront_products(
    ...
    for product in products:
        ...
        transformed = await storefront_product_service.transform_product_images(product_dict)
...
async def get_product_detail(
    ...
    product_data = await storefront_product_service.get_product_detail_for_storefront(db, tenant_id, product_id)
    ...
    transformed_main = await storefront_product_service.transform_product_images(main_product)
...
async def get_product_collections(
    ...
    tenant_id = uuid.UUID(tenant_context["tenant_id"])
    collections = await storefront_product_service.get_product_collections(db, tenant_id)
