...
from app.app.core.security import get_tenant_id_from_headers, validate_jwt_ws
from app.app.services.analytics_realtime_service import get_analytics_realtime_manager
