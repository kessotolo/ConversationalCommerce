...
from backend.app.core.errors.exceptions import EntityNotFoundException, UnauthorizedException
        ...
        *,
        ...
        if not admin_user.is_super_admin:
            raise UnauthorizedException(
                "Only super admins can impersonate tenant owners")
        ...
        try:
            ...
            if tenant_id:
                ...
                if token_tenant_id != tenant_id:
                    raise UnauthorizedException(
                        "Impersonation token is for a different tenant")
...
admin_impersonation_service = ImpersonationService()
