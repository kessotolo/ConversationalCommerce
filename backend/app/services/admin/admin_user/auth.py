...
async def get_admin_user_permissions(
    ...
    """
    from backend.app.services.admin.admin_user.roles import get_admin_user_roles
    from backend.app.services.admin.role.permissions import get_role_permissions
