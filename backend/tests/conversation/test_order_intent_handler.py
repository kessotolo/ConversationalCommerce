...
from app.conversation.nlp.intent import ParsedIntent, IntentType
from app.models.order import Order
from app.models.order_channel_meta import OrderChannelMeta, ChannelType


@pytest.mark.asyncio
async def test_checkout_intent_creates_proper_channel_metadata(db_session, mocker, fake_product, fake_cart):
