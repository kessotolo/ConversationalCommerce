...
class TestDomainVerificationMiddleware:
    ...
    async def test_dispatch_custom_domain(self, mock_verify):
        ...
        mock_verify.assert_called_once_with("shop.example.com", request.state.tenant_context["tenant_id"])
...
class TestDomainVerificationService:
    ...
    async def test_verify_all_domains(self, mock_verify_ssl, mock_verify_dns, mock_session_local):
        ...
        mock_db.query.return_value.filter.return_value.all.return_value = [mock_config1, mock_config2]
