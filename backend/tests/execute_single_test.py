...
def apply_aggressive_mocks():
    ...
    requests_mock.get = unittest.mock.MagicMock(return_value=unittest.mock.MagicMock(
        status_code=200,
        text="Mocked response",
        json=lambda: {"status": "mocked"}
    ))
    ...
    try:
        ...
        spacy_mock.load = unittest.mock.MagicMock(return_value=unittest.mock.MagicMock())
    ...
    try:
        ...
        detoxify_mock.Detoxify = unittest.mock.MagicMock(return_value=unittest.mock.MagicMock(
            predict=unittest.mock.MagicMock(return_value={
                'toxicity': 0.0,
                'severe_toxicity': 0.0,
                'obscene': 0.0,
                'identity_attack': 0.0,
