"""proper_schema_relationships

Revision ID: 3e2ad54cdc4c
Revises: 5a850b2f9d3c
Create Date: 2025-06-26 10:06:36.054335
...
def upgrade() -> None:
    ...
    op.create_foreign_key(op.f('fk_complaints_tenant_id_tenants'), 'complaints', 'tenants', ['tenant_id'], ['id'])
    op.create_foreign_key(op.f('fk_complaints_order_id_orders'), 'complaints', 'orders', ['order_id'], ['id'])
    op.create_foreign_key(op.f('fk_conversation_events_tenant_id_tenants'), 'conversation_events', 'tenants', ['tenant_id'], ['id'])
    op.create_foreign_key(op.f('fk_conversation_events_order_id_orders'), 'conversation_events', 'orders', ['order_id'], ['id'])
    op.create_foreign_key(op.f('fk_products_tenant_id_tenants'), 'products', 'tenants', ['tenant_id'], ['id'])
    op.drop_constraint(op.f('seller_profiles_slug_key'), 'seller_profiles', type_='unique')
    op.create_unique_constraint(op.f('uq_seller_profiles_slug'), 'seller_profiles', ['slug'])
    op.create_foreign_key(op.f('fk_storefront_themes_tenant_id_tenants'), 'storefront_themes', 'tenants', ['tenant_id'], ['id'])
    op.create_foreign_key(op.f('fk_users_tenant_id_tenants'), 'users', 'tenants', ['tenant_id'], ['id'])
