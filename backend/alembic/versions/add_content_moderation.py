...
Revision ID: add_content_moderation
Revises: add_tenant_quotas
...
revision = 'add_content_moderation'
down_revision = 'add_tenant_quotas'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Create content_analysis_results table
    op.create_table(
