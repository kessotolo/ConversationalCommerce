...
const BannerItem: React.FC<BannerItemProps> = ({
  ...
  return (
    <div
      ...
      className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors border-b relative ${selectedBannerId && selectedBannerId === banner.id ? 'bg-blue-50' : ''
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`text-xs px-2 py-1 rounded-full ${statusFilter === 'all'
