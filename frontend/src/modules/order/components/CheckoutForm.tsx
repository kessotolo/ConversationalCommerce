...
export function CheckoutForm({
  ...
  const [shippingMethod, setShippingMethod] = useState<ShippingMethod | string>(ShippingMethod.RIDER);
  ...
  useEffect(() => {
    ...
    fetch('/api/v1/shipping/providers')
      ...
      .catch(() => {
        setAvailableProviders([]); // fallback to enum
      });
  }, []);
      ...
      try {
        ...
        const orderRequest: CreateOrderRequest = {
          ...
          shipping: {
            ...
            pluginMeta: shippingMethod === 'other' && pluginProvider ? { provider: pluginProvider } : undefined,
