      ...
      <form className="flex-1 flex flex-col gap-4 px-4" onSubmit={handleNext}>
        ...
        {step === 2 && (
          <>
            ...
            {uploadProgress !== null && (
              <div className="text-blue-600 text-xs mt-2 animate-pulse">
            ...
            {kycStatus === 'pending' && (
              <div className="text-yellow-600 text-xs mt-2">KYC Status: Pending review...</div>
            )}
            {kycStatus === 'verified' && (
              <div className="text-green-600 text-xs mt-2">KYC Status: Verified ✅</div>
            )}
            {kycStatus === 'rejected' && (
              <div className="text-red-600 text-xs mt-2">KYC Status: Rejected ❌</div>
            )}
