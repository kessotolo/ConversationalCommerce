...
// Add ThemeColors type for colorState and updateColor
  ...
  const handleSave = async () => {
    try {
      ...
      const attemptSave = async () => {
        try {
          ...
          notification.className =
            'fixed bottom-4 right-4 bg-green-50 border-l-4 border-green-500 p-4 text-green-700 shadow-md rounded';
      ...
      errorNotification.className =
        'fixed bottom-4 right-4 bg-red-50 border-l-4 border-red-500 p-4 text-red-700 shadow-md rounded';
      errorNotification.textContent =
        'Failed to update theme. Changes saved locally. Will retry when online.';
        ...
        <div className="lg:col-span-1">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="rounded-lg border p-4 overflow-hidden">
              <div
                style={{ backgroundColor: colorState.background }}
