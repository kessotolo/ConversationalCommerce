        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span
                          className={section.enabled ? 'font-medium' : 'font-medium text-gray-500'}
                        >
                          {section.name}
                        </span>
                      </div>
            ...
            <div className="mt-4 text-sm text-gray-500">
              Drag and reorder sections to change their position on your storefront. Toggle
              visibility to show or hide sections.
            </div>
          </div>
        </div>
