          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#e6f0eb] flex flex-col md:flex-row gap-8 items-center">
            <div className="flex-1">
              ...
              <div className="border rounded-2xl p-6 bg-[#f8faf8] flex flex-col gap-4 max-w-md mx-auto shadow-inner">
                <div
                  className="h-12 rounded-xl flex items-center justify-center mb-2"
                  style={{
              ...
              <div className="flex justify-end mt-4">
                <a
                  ...
                  className="px-4 py-2 bg-[#6C9A8B] text-white rounded-full font-semibold shadow hover:bg-[#4e6e5e] transition-all"
                >
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  defaultValue={`${theme.name} - Online Store`}
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  defaultValue="Shop our latest products with secure checkout and fast delivery."
                />
              </div>
            </div>
          </div>
